...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final KLibraryAccessors laccForKLibraryAccessors = new KLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>k</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KLibraryAccessors getK() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class KLibraryAccessors extends SubDependencyFactory {
        private final KMongoLibraryAccessors laccForKMongoLibraryAccessors = new KMongoLibraryAccessors(owner);

        public KLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>k.mongo</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KMongoLibraryAccessors getMongo() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
    ...
    public static class KMongoLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("k.mongo.coroutine");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kmongo</b> with value <b>4.11.0</b>
         * <p>
        ...
        /**
         * Version alias <b>kobweb</b> with value <b>0.16.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class JetbrainsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jetbrains.compose</b> with value <b>1.5.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
