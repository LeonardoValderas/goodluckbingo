...
fun GameItem(
    ...
    Row(
        ...
        Row(
            ...
            SpanText(
                modifier = Modifier
                    .backgroundColor(if (game.isFinished) Colors.Red else Colors.Green)
                ...
                text = if (game.isFinished) FINISHED_BINGO else ACTIVE_BINGO
            )
            SpanText(
                modifier = Modifier
                    .weight(1F)
