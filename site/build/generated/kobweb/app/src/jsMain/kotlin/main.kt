...
public fun main() {
    ...
    com.varabyte.kobweb.core.init.initKobweb(router) { ctx ->
        ctx.router.register("/dashboard/") {
                com.lavsystems.goodluckbingo.pages.dashboard.Dashboard() }
        ctx.router.register("/game/game") { com.lavsystems.goodluckbingo.pages.game.GameList() }
        ctx.router.register("/login/") { com.lavsystems.goodluckbingo.pages.login.Login() }
    ...
    AppGlobals.initialize(mapOf("title" to "GoodLuckBingo"))
    renderComposable(rootElementId = "root") {
        com.lavsystems.goodluckbingo.AppEntry {
