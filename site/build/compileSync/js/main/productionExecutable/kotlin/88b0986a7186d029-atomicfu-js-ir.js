(function (root, factory) {
  ...
  protoOf(AtomicRef).ck = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).dk = function () {
  ...
  protoOf(AtomicBoolean).ek = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).dk = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).fk = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).dk = function () {
    return this.kotlinx$atomicfu$value;
  };
