(function (root, factory) {
  ...
  var prepareSilkFoundation$composable = kotlin_com_varabyte_kobweb_silk_foundation.$_$.e1;
  ...
  function SilkApp$composable(content, $composer, $changed) {
    ...
    $composer_0 = $composer_0.e12(766681329);
    var $dirty = $changed;
    if (($changed & 14) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.d1h(SilkApp$composable$lambda_0(content, $changed));
    }
  }
